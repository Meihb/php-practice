...
<!--    <span><img src=https://yunqi-tech.oss-cn-hangzhou.aliyuncs.com/t.png?x-oss-process=image/watermark,image_aW1wb3J0LmpwZw==,g_se,x_1,y_1 title="表情" id="imgbq"><img src=https://yunqi-tech.oss-cn-hangzhou.aliyuncs.com/e.png?x-oss-process=image/watermark,image_aW1wb3J0LmpwZw==,g_se,x_1,y_1 title="上传图片"><form><input type="file" title="上传图片" id="upimg"></form></span>-->
    <p><input id="nrong"></p>
</div>
