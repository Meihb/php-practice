...
/*
$Id: nusoap.php,v 1.2 2006/12/30 02:05:46 litianhua Exp $
...
// necessary classes
require_once('class.nu_soapclient.php');
...
* @version  $Id: nusoap.php,v 1.2 2006/12/30 02:05:46 litianhua Exp $
* @access   public
*/
class nusoap_base {
	/**
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (nu_soapclient->response has contents of the response)");
			return false;
		}
...
/**
*
* nu_soapclient higher level class for easy usage.
*
* usage:
*
* // instantiate client with server info
* $nu_soapclient = new nu_soapclient( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $nu_soapclient->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($nu_soapclient);
*
...
* @access   public
*/
class nu_soapclient extends nusoap_base  {
	...
	* @access   public
	*/
	function nu_soapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class soap_proxy_'.$r.' extends nu_soapclient {
	'.$evalStr.'
}';
		return $evalStr;
	}
